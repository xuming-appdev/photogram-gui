...
def create
#Parameters: {"query_impage"=>"https://www.chicagobooth.edu/mba/mba-life/the-classroom-experience", "query_caption"=>"123", "query_owner_id"=>"117"}
  
input_image=params.fetch("query_impage")
